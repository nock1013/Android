...
//Adapter안에 ViewHolder포함 - 정의(ListView사용할때와 동일한 역활)
//            ----------
//                |_ Inner Class로 정의
// 어뎁터 커스틍 마이징 구조!!
public class SimpleItemAdapter extends RecyclerView.Adapter<SimpleItemAdapter.ViewHolder> {
    ...
    //2. ViewHolder객체를 만들어서 1번에서 생성한뷰를 넘긴다.
    //3. ViewHolder객체 안에서 onCreateViewHolder메소드에서 리턴박은 객체에서 데이터를 연결할 뷰를 찾아온다.
    //4. onBindViewHolder메소드에서 ViewHolder가 갖고 있는 구성요소에 데이터 연결하기
