...
public class ActionBarTest extends AppCompatActivity {
    ...
    TextView result2;
    ListView listView;
    String[] datalist = {"java","servlet","jsp","html","android","spring","spark","sqoop",
                        "spark","sqoop"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //리스트뷰가 검색이 가능하도록 설정 = setTextFilterEnabled(true);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            //searcView의 텍스트가 변경될때 호출
            @Override
            public boolean onQueryTextChange(String newText) {
                result2.setText(newText);
                //전달되는 입력하는 문자열을 이용해서 listView에서 필터링
